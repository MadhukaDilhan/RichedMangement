 ...
 * @author DIL
 */
public class sellBook extends javax.swing.JDialog {

    /**
     * Creates new form sellBook
     */
    public sellBook(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        MainLabel.setText("Books Sell");
        MainLabel.setToolTipText("");

        jLabel1.setText("Books Catogory No :");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                sellBook dialog = new sellBook(new javax.swing.JFrame(), true);
